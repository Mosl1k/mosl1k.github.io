...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 05 2015 г., 14:12
...
(2, 'a010885', 1, 2, 1436059856, 1436146256);
...
(2, 1, 'a010885', 100, 1436067410, 0),
(3, 1, 'a010885', 100, 1436067410, 0);
...
--
-- Дамп данных таблицы `db_kamikadze`
--

INSERT INTO `db_kamikadze` (`id`, `user`, `user_id`, `item`, `date_add`, `date_del`, `stavka`, `status`) VALUES
(1, 'a010885', 1, 1, 1436065114, 1436065116, 10, '2');
...
(2, 1, 'a010885', 110, 1436065195, 0),
(3, 1, 'a010885', 110, 1436065195, 0);
...
(1, 1, 'a010885', '9Баклажан', 500000, 1436050906, 1437346906);
...
(1, 'a010885', 'a010885@yandex.ru', '123456', 'Admin', 1, 1, 1428732941, 1436068484, 2130706433, 0, 0, 0, '');
