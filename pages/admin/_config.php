...
if(isset($_POST["admin"])){
	...
	$peach8_in_h = intval($_POST["8_in_h"]);
	$watermelon9_in_h = intval($_POST["9_in_h"]);
	...
	$amount_peach8_t = intval($_POST["amount_8_t"]);
	$amount_watermelon9_t = intval($_POST["amount_9_t"]);
	...
	if($errors){
		...
		amount_8_t = '$amount_peach8_t',
		amount_9_t = '$amount_watermelon9_t',
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#EFEFEF">
   ...
   <tr>
    <td><b>Плодородность в час (8) (мин 6):</b></td>
	<td width="150" align="center"><input type="text" name="8_in_h" value="<?=$data_c["8_in_h"]; ?>" /></td>
  </tr>
  
  <tr bgcolor="#EFEFEF">
    <td><b>Плодородность в час (9) (мин 6):</b></td>
	<td width="150" align="center"><input type="text" name="9_in_h" value="<?=$data_c["9_in_h"]; ?>" /></td>
  </tr>
  ...
  <tr bgcolor="#EFEFEF">
    <td><b>Стоимость саженца серебро (8):</b></td>
	<td width="150" align="center"><input type="text" name="amount_8_t" value="<?=$data_c["amount_8_t"]; ?>" /></td>
  </tr>
  
  <tr bgcolor="#EFEFEF">
    <td><b>Стоимость саженца серебро (9):</b></td>
	<td width="150" align="center"><input type="text" name="amount_9_t" value="<?=$data_c["amount_9_t"]; ?>" /></td>
  </tr>
