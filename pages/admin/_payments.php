...
if(isset($_GET["option"])) {
	...
	$id = $_GET["id"];
		...
		echo '<br><b style="color:#2E8B57">Выплачено!</b><br>';
...
if(isset($_GET["vozvrat"])) {
	...
	$sum = $_GET["sum"];
		...
		echo '<br><b style="color:#2E8B57">Возвращено!</b><br>';
...
<center><a href="/?menu=admin384&sel=payments">Запросы на выплату</a> || <a href="/?menu=admin384&sel=payments&balance">Баланс на Payeer</a> || 
<a href="/?menu=admin384&sel=payments&list_day">По дням</a> || <a href="/?menu=admin384&sel=payments&last_31">График за 30 дней</a></center><BR />
<?PHP
# График
...
<?PHP
	...
	<td align="center"><a href="/?menu=admin384&sel=payments&vozvrat=vozvrat&id=<?=$data["id"]; ?>&sum=<?=$data["serebro"]; ?>">Вернуть<?=$data["purse"]; ?></a></td>
	<td align="center"><a href="/?menu=admin384&sel=payments&option=pay&id=<?=$data["id"]; ?>">Оплачено</a></td>
  	</tr>
	<?PHP
