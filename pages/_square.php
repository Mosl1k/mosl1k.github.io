</br><div style="clear: both; height: 40px;"></div>
...
if(!isset($_SESSION["user"])) {
	echo '<tr><td align="center" colspan="6"><font color="red"><center>Необходимо войти в систему!</center></font></td></tr>';
        ...
        <tbody>
    		...
    		<table border="0" cellpadding="10" cellspacing="20" width="500">
    			<tbody><tr><td bgcolor="#DDDDDD">
    				<b><? if ($view["id"]==1 OR $view["id"]==1) echo '<font color="red"><b>'.$view['user'].'</b></font>'; else echo $view['user']?>&nbsp;&nbsp; <?=$view["data"]?> <?php if ($usid==1 OR $usid==1) echo '<a href="/square/'.$view['sq_id'].'">удалить</a>';?></b>
					   <hr> 			
