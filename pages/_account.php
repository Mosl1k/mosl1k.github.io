...
if(isset($_GET["sel"])){
	...
	switch($smenu){
		...
		case "others": include("pages/account/_others.php"); break; // Статистика
		...
		case "kredit": include("pages/account/_kredit.php"); break; // Кредит
		...
		case "square": include("pages/account/_square.php"); break; // Чат
